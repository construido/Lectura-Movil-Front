            ...
            <div class="card">
                <div class="card-header">
                    <div class="col-xl-6">
                        <div class="text-center">
                            <h5>
                                <label class="mx-3"> <b> Procesada [{{lecturados}}/{{pendientes}}] </b> </label>
                ...
                <b-overlay :show="show" class="d-inline-block">
                    <div class="card-body">
                        ...
                        <div v-else>
                            <textarea readonly class="form-control text-center py-5 my-2" name="" id="" rows="1"> SIN MEDIDOR </textarea>
                        </div>                        
